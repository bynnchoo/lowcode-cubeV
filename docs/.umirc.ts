...
const productPath = `/lowcode-chart-material@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('lowcode-chart-material', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'lowcode-chart-material': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
